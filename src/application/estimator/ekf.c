...
void ekf_matrix_predict(
    ...
    // DISCRETE COVARIANCE
    // F'
    double F_transp_flat[SIZE_STATE * SIZE_STATE] = {0};
    ...
    // dt * Q
    double Q_dt_flat[SIZE_STATE * SIZE_STATE] = {0};
...
void ekf_matrix_correct(
    ...
    const double y_meas[SIZE_IMU_MEAS] = {0};
    memcpy((double *)y_meas, (double *)&y_meas_full->array[3], SIZE_IMU_MEAS * sizeof(double));
    ...
    double P_corr_flat[SIZE_STATE * SIZE_STATE] = {0};
    ...
    // H' = trans(H) // b1
    double H_transp_flat[SIZE_IMU_MEAS * SIZE_STATE] = {0};
    ...
    // PH' = P * H' // b2
    double PH_transp_flat[SIZE_STATE * SIZE_IMU_MEAS] = {0};
    ...
    // HPH' = H * PH' // b3
    double HPH_transp_flat[SIZE_IMU_MEAS * SIZE_IMU_MEAS] = {0};
    ...
    // L = HPH' + R // b1
    double L_flat[SIZE_IMU_MEAS * SIZE_IMU_MEAS] = {0};
    ...
    // Linv = inv(L) // b3
    double L_inv_flat[SIZE_IMU_MEAS * SIZE_IMU_MEAS] = {0};
    ...
    // E' = trans(E) // b1
    double E_transp_flat[SIZE_STATE * SIZE_STATE] = {0};
    ...
    // PE' = P*E' // b3
    double PE_transp_flat[SIZE_STATE * SIZE_STATE] = {0};
    ...
    // EPE' = E*PE' // b1
    double EPE_transp_flat[SIZE_STATE * SIZE_STATE] = {0};
    arm_matrix_instance_f64 EPE_transp = {
        .numRows = SIZE_STATE, .numCols = SIZE_STATE, .pData = EPE_transp_flat
    };
    arm_mat_mult_f64(&E, &PE_transp, &EPE_transp); // right

    // K_transp = trans(K) // b2
    double K_transp_flat[SIZE_IMU_MEAS * SIZE_STATE] = {0};
    ...
    // RK' = R*K' // b3
    double RK_transp_flat[SIZE_IMU_MEAS * SIZE_STATE] = {0};
    ...
    // KRK' = K*RK' // b2
    double KRK_transp_flat[SIZE_STATE * SIZE_STATE] = {0};
