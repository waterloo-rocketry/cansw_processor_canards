...
static const float Q_diag[SIZE_ESTIMATOR_STATE] = {
...
math_init_matrix_diag(&Q, SIZE_ESTIMATOR_STATE, Q_diag);
...
void ekf_matrix_predict(
    ...
    */
    ...
    // FP = F*P // b2
    //arm_matrix_instance_f32 FP = {SIZE_ESTIMATOR_STATE, SIZE_ESTIMATOR_STATE, buffer2}; // experiment to "hack" th DSP library, 
