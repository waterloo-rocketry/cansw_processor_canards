...
DECLARE_FAKE_VALUE_FUNC(HAL_StatusTypeDef, HAL_UART_RegisterCallback, UART_HandleTypeDef *, HAL_UART_CallbackIDTypeDef, pUART_CallbackTypeDef);

/** @brief Mock for HAL_UART_RegisterRxEventCallback function */
DECLARE_FAKE_VALUE_FUNC(HAL_StatusTypeDef, HAL_UART_RegisterRxEventCallback, UART_HandleTypeDef *, pUART_RxEventCallbackTypeDef);
